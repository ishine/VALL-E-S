...
from modules.duration_pitch import DurationPitchPredictor
from utils.opt_and_scheduler import get_optimizer, get_scheduler, Eden
from utils.utils import (AttributeDict, MetricsTracker, get_params, set_batch_count,
...
class VALL_E_Trainer(nn.Module):
    def __init__(self, cfg: omegaconf.DictConfig):
        ...
        self.duration_pitch = DurationPitchPredictor(cfg)
        #self.aligner = Aligner(cfg)
        
    def get_model(self, cfg, device):
        from models.valles import VALLE_S
        model_cfg = cfg.model
        model = VALLE_S(
