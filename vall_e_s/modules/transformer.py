    ...
    def __init__(
        ...
        if cross_attention:
            ...
            **factory_kwargs,
            ...
            self.norm_cros = nn.LayerNorm(d_model, eps=1e-5, **factory_kwargs)
        ...
        self.cross_attention: Optional[nn.Module] = None
        ...
        if self.norm_first:
            ...
            if cross_attention_src is not None:
                x = x + self._cross_attention_block(
                    self.norm_cros(x), cross_attention_src
                )
