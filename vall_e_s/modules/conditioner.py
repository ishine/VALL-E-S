...
class SimpleEmbedding(nn.Module):
    ...
    def forward(self, y):
        ...
        assert isinstance(y, torch.cuda.LongTensor), f"Expected dtype {torch.cuda.LongTensor}, got {y.dtype}"
...
class RangeEmbedding(nn.Module):
    ...
    def forward(self, pos_start, pos_end=None):
        ...
        if n_time != 1:
            ...
            interpolation  = (torch.arange(0, n_time, dtype=torch.float, device='cuda').view(1,n_time)/n_time)
